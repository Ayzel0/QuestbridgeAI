  ...
  return (
    <div>
      ...
      <div className="flex-col justify-center">
        ...
        <div className='flex justify-center w-auto mx-auto text-center'>
          <h2 className="text-xl mb-5">
            Our solution is backed by leading <br></br> <span className='text-cyan-500 font-semibold'>cloud</span> and <span className='text-cyan-500 font-semibold'>artificial intelligence</span> solutions in the industry
          </h2>
        </div>
