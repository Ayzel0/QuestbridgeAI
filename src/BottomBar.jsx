...
const BottomBar = () => {
  return (
    <div className='bg-cyan-800 flex items-center'>
      <h1 className='inline-block ml-12 text-white text-lg'>Made for the 2024 HoyaHacks Hackathon. Data from Questbridge; AI Chatbot powered by Azure and Cloudforce.</h1>
